...
type Presence struct {
	...
	SessionID string    `gorm:"type:text;not null;index:idx_presence_session_id"`
	...
	State     string    `gorm:"type:text;not null;check:state IN ('typing', 'paused', 'online', 'offline')"`
